...
def main():
    ...
    pd.DataFrame(rows).to_csv("reports/metrics/week6_misclassified_samples.csv", index=False)
    print("Saved week6 metrics, confusion matrix, and misclassified samples.")
